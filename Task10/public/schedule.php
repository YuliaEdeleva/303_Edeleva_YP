  ...
  <body>
   <div class="container">
       <div class="row">
           ...
           <?php foreach ($shedule as $value) {?>
              <tr>
                ...
                <td>
				  ...
				  <a href="?delete=<?=$value['id'] ?>$master_id=<?$fio[0]['master']?>" class="btn btn-danger btn-sm" 
           ...
           <button class="btn btn-success mt-3" data-toggle="modal" data-target="#AddShModal">Добавить запись</button>
           </div>
       </div>
   </div>
