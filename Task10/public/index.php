       ...
       <div class="row">
           ...
           <?php foreach ($masters as $value) {
             ...
             ?>
                ...
                <a href="schedule.php?master_id=<?=$value['id']?> " class="btn btn-info ">График</a>
                <a href="works.php?master_id=<?=$value['id'] ?>" class="btn btn-info" >Выполненные работы</a>
           ...
           <button class="btn btn-success mt-3" data-toggle="modal" data-target="#AddModal">Добавить запись</i></button>
