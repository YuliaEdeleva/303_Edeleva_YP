...
DROP TABLE IF EXISTS master_specialization;
...
INSERT INTO master (id, last_name, name, patronymic, DOB, phone_number, percent_, gender, id_specialization) values
...
INSERT INTO master_specialization (id, id_master, id_service) VALUES
(0, 0, 5),
(1, 0, 6),
(2, 1, 1),
(3, 1, 5),
...
INSERT INTO schedule (id, id_master, work_date, start_time, end_time) VALUES
...
INSERT INTO work_info (id, id_master, id_service, work_date, start_work_time, end_work_time, work_state, client_name, client_last_name, client_patronymic, client_phone_number) VALUES
